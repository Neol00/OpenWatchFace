// LOCAL PATCH (ESP32-S3-WatchFace): make the forced-temperature (TSSET) values
// build-time tunable. On the UC8253 the waveform is selected BY TEMPERATURE, so
// these two constants are the speed/quality dial: higher = faster + weaker
// drive (greyer text, more ghosting). Defaults below are GxEPD2's originals, so
// leaving them undefined preserves upstream behaviour exactly.
//
//   GXEPD2_310_TSSET_PART  partial refresh, upstream 0x79 (121 C), ~700 ms
//   GXEPD2_310_TSSET_FULL  full refresh,    upstream 0x5A (90 C),  ~1015 ms
//                          (an unforced full refresh is ~3082 ms)
#ifndef GXEPD2_310_TSSET_PART
#define GXEPD2_310_TSSET_PART 0x79
#endif
#ifndef GXEPD2_310_TSSET_FULL
#define GXEPD2_310_TSSET_FULL 0x5A
#endif
...
void GxEPD2_310_GDEQ031T10::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_310_GDEQ031T10::writeImageToPrevious(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_310_GDEQ031T10::writeImagePartToPrevious(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_310_GDEQ031T10::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (black)
  {
...
void GxEPD2_310_GDEQ031T10::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (data1)
  {
...
void GxEPD2_310_GDEQ031T10::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (black)
  {
...
void GxEPD2_310_GDEQ031T10::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (data1)
  {
...
void GxEPD2_310_GDEQ031T10::powerOff(void)
{
  _PowerOff();
}
...
void GxEPD2_310_GDEQ031T10::_Update_Full()
{
  if (useFastFullUpdate)
  {
    ...
    _writeData(GXEPD2_310_TSSET_FULL);  // LOCAL PATCH: was 0x5A (90 C, 1015000us)
...
void GxEPD2_310_GDEQ031T10::_Update_Part()
{
  if (hasFastPartialUpdate)
  {
    ...
    _writeData(0x02);    // TSFIX
    _writeCommand(0xE5); // Force Temperature (TSSET)
    _writeData(GXEPD2_310_TSSET_PART);  // LOCAL PATCH: was 0x79 (121 C)
  }
  _writeCommand(0x50);
  _writeData(0xD7);
  _PowerOn();
