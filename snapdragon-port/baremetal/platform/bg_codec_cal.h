/* bg_codec_cal.h -- the BG speaker's calibration payload, lifted from the stock vendor module
 * audio_bg_codec.ko (firmware/gen5-C3F9453E4746/emmc/gen5-vendor.img, /lib/modules, .rodata
 * 0x212c..0x2cfb).
 *
 * bg_cdc_cal() builds the 3136-byte INIT_PARAMS payload as
 *     [u32 len1][cal1 (<= 20 B)][u32 len2][cal2 (<= 3076 B)]
 * from wcdcal_get_fw_cal() blocks 4 and 5; these are the module's built-in defaults.
 * cal2 is an NXP TFA container for the TFA9897 amp (customer "NXP", application "Demo"):
 * chunks of {u16 size, u16 type} + block -- PA1_00 patch 1770, CO1_03 config 237,
 * SP1_00 speaker 496, PR1_00 profile 123, EQ1_00 eq 357.
 *
 * Until now bgcom.c sent len1 = 20 with a nearly empty cal1 and len2 = 0: no amp configuration
 * at all, which is why the DSP clocked PCM out (gen5-modem-8..11) and nothing was audible. */
#pragma once
#include <stdint.h>

static const uint8_t k_bg_cal1[20] = {
    0x60, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x06, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x80, 0x06, 0x00, 0x00, 0x00,
};

static const uint8_t k_bg_cal2[3003] = {
