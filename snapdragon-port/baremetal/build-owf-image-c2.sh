...
if [ ! -f ../firmware/c2/wcnss_nv.c ] && [ -f ../firmware/gen4/wcnss_nv.c ]; then
  mkdir -p ../firmware/c2
  sed -e 's/^const uint8_t wcnss_mac\[6\] = .*/const uint8_t wcnss_mac[6] = { 0x9A, 0x29, 0xA6, 0xF1, 0xAC, 0xC2 };  \/* locally administered, derived for the C2 *\//' \
      ...
      ../firmware/gen4/wcnss_nv.c > ../firmware/c2/wcnss_nv.c
  echo "[owf] firmware/c2/wcnss_nv.c generated from the Gen 4 NV blob"
fi
if [ -f ../firmware/c2/wcnss_nv.c ]; then cc_one ../firmware/c2/wcnss_nv.c "" "$B/wcnss_nv.o"; else echo "[owf] no firmware/c2/wcnss_nv.c - NV download will be skipped"; fi
