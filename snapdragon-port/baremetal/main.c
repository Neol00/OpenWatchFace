/* main.c — Phase 2 proof: FreeRTOS multitasking on the snapdragon-port runtime.
 *
...
void main(void)
{
    ...
    (void)heartbeat_task; (void)counter_task;
    {
         ...
         * heap being absent. */
        static const uint32_t k_stack_try[] = { 65536, 32768, 16384, 8192 };   /* words; v197: 256 KB first (TLS on the UI task) */
