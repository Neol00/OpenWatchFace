...
# Default: the REAL skipjack tree, extracted from a stock boot partition
# (2026-09-05, TicWatch C2+; byte-identical to the C2's own). It carries TWO
# qcom,board-id entries, <8 0x105> and <8 0x05>: the C2 reports subtype 0x105
