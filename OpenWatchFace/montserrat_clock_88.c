 ...
 * Size: 88 px
 * Bpp: 4
 * Opts: --bpp 4 --size 88 --no-compress --stride 1 --align 1 --font Montserrat-Light.ttf --range 48-58 --format lvgl -o montserrat_clock_88.c
 ******************************************************************************/
...
#ifndef MONTSERRAT_CLOCK_88
#define MONTSERRAT_CLOCK_88 1
#endif

#if MONTSERRAT_CLOCK_88
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 926, .box_w = 50, .box_h = 61, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 1525, .adv_w = 497, .box_w = 21, .box_h = 61, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2166, .adv_w = 793, .box_w = 45, .box_h = 61, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3539, .adv_w = 786, .box_w = 44, .box_h = 61, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4881, .adv_w = 921, .box_w = 54, .box_h = 61, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 6528, .adv_w = 786, .box_w = 44, .box_h = 61, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 7870, .adv_w = 848, .box_w = 47, .box_h = 61, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 9304, .adv_w = 818, .box_w = 46, .box_h = 61, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 10707, .adv_w = 890, .box_w = 48, .box_h = 61, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 12171, .adv_w = 848, .box_w = 47, .box_h = 61, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 13605, .adv_w = 282, .box_w = 8, .box_h = 46, .ofs_x = 5, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserrat_clock_88 = {
#else
lv_font_t montserrat_clock_88 = {
#endif
