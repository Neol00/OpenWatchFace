/* board_fossil_darter.h -- Fossil Sport "darter": the Gen 5 board with a 390x390 AUO AMOLED
 * (qcom,mdss_dsi_auo_x120_amoled_cmd) and the Gen 5 crown. Generated from board_fossil_gen5e.h 2026-09-15; keep in step. */
...
#define BOARD_NAME   "Fossil Sport"
...
/* Two extra side pushers exist on this watch, but on the Wear 3100 they sit
 * behind the BG co-processor and are NOT wired up yet: virtual pins 203/204
 * read "released" (no stem_keys driver in this image). Declared now so the
 * Buttons app and its two buttons x short/long entries are already in place. */
