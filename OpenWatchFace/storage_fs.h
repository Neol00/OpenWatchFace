 ...
 *    - SD     : a removable microSD card (when one is inserted + mounts), reached
 *               board-neutrally via sd_fs() in sd_card.h (SDMMC or SPI per board).
