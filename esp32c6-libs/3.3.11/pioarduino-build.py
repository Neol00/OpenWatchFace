...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_hw_support", "debug_probe", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_hw_support", "mspi_timing_tuning", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_hw_support", "mspi_timing_tuning", "tuning_scheme_impl", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_hw_support", "power_supply", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "heap", "tlsf"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "soc", "esp32c6", "register"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_rom", "esp32c6", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_rom", "esp32c6", "include", "esp32c6"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "lib"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "lib", "dnssd"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "OpenThread"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "third_party", "jsoncpp", "repo", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "third_party", "nlfaultinjection", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "third_party", "nlassert", "repo", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "third_party", "nlio", "repo", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "zzz_generated", "app-common"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp-idf", "espressif__esp_matter"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_matter", "zap_common"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_matter", "data_model"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_matter"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_matter", "utils"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_matter_console"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_matter", "data_model_provider"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_matter_bridge"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "ESP32"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "ESP32", "bluedroid"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "ESP32", "nimble"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "ESP32", "route_hook"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "common", "ble_log", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "common", "ble_log", "deprecated", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "common", "tinycrypt", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "common", "tinycrypt", "port"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ans", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "bas", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "dis", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "gap", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "gatt", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "hr", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "htp", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ias", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ipss", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "lls", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "prox", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "cts", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "tps", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "hid", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "sps", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "cte", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "util", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "store", "ram", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "store", "config", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ras", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "porting", "nimble", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "port", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "host", "nimble", "nimble", "nimble", "transport", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "v1.1", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "v1.1", "dfu"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "v1.1", "mbt"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_driver_twai", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_delta_ota", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_encrypted_img", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_security", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_driver_bitscrambler", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_hal_ieee802154", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_hal_ieee802154", "esp32c6", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_tee", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "rt", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "ulp", "ulp_common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "ulp", "lp_core", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "ulp", "lp_core", "shared", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__rmaker_cmd_resp", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__rmaker_common_events", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__rmaker_system_ctrl", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__rmaker_time_sync", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__rmaker_console", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__rmaker_work_queue", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__rmaker_common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__cbor", "tinycbor", "src"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp-modbus", "modbus", "mb_transports"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp-modbus", "modbus", "mb_controller", "common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp-modbus", "modbus", "mb_objects", "common"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp-modbus", "modbus", "mb_ports", "common"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp-modbus", "modbus", "mb_ports", "serial"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp-modbus", "modbus", "mb_ports", "tcp"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_modem", "command", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "espressif__esp_daylight", "include"),
    ...
    LIBS=[
        "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lapp_trace", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lunity", "-lcmock", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_driver_cam", "-lesp_eth", "-lesp_hal_ieee802154", "-lesp_hid", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_https_server", "-lesp_lcd", "-lprotobuf-c", "-lprotocomm", "-lesp_local_ctrl", "-lespcoredump", "-lwear_levelling", "-lfatfs", "-lieee802154", "-ljson", "-lmqtt", "-lnvs_sec_provider", "-lrt", "-lspiffs", "-lulp", "-lwifi_provisioning", "-lespressif__esp-nn", "-lespressif__esp-tflite-micro", "-lespressif__mdns", "-lespressif__esp_secure_cert_mgr", "-lespressif__json_parser", "-lespressif__json_generator", "-lespressif__esp_delta_ota", "-lespressif__esp_encrypted_img", "-lespressif__rmaker_cmd_resp", "-lespressif__rmaker_common_events", "-lespressif__rmaker_system_ctrl", "-lespressif__rmaker_time_sync", "-lespressif__rmaker_console", "-lespressif__rmaker_work_queue", "-lespressif__rmaker_common_2", "-lespressif__esp_diagnostics", "-lespressif__cbor", "-lespressif__esp_diag_data_store", "-lespressif__esp_insights", "-lespressif__esp-serial-flasher", "-lespressif__esp_rcp_update", "-lespressif__esp_matter", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__esp-zigbee-lib", "-lespressif__libsodium", "-lespressif__esp-dsp", "-lespressif__esp_modem", "-lespressif__esp_daylight", "-lespressif__esp_schedule", "-lespressif__network_provisioning", "-lespressif__esp_rainmaker", "-lespressif__qrcode", "-ljoltwallet__littlefs", "-lfb_gfx", "-lapp_trace", "-lapp_trace", "-lcmock", "-lunity", "-lesp_driver_cam", "-lesp_lcd", "-lnvs_sec_provider", "-lrt", "-lwifi_provisioning", "-lespressif__esp-tflite-micro", "-lespressif__esp-nn", "-lm", "-lesp_hid", "-lespressif__esp_matter", "-lfatfs", "-lwear_levelling", "-lspiffs", "-lespressif__esp_delta_ota", "-lespressif__esp_encrypted_img", "-lespressif__esp_insights", "-lespressif__esp_diagnostics", "-lespressif__esp_diag_data_store", "-lespressif__esp_rcp_update", "-lespressif__esp-serial-flasher", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__esp-zigbee-lib", "-lieee802154", "-lesp_hal_ieee802154", "-lespressif__esp-zigbee-lib", "-lespressif__libsodium", "-lespressif__esp-dsp", "-lespressif__esp_modem", "-lespressif__esp_rainmaker", "-lesp_local_ctrl", "-lesp_https_server", "-lespressif__mdns", "-lesp_eth", "-lespressif__esp_secure_cert_mgr", "-lespressif__json_parser", "-lespressif__json_generator", "-lespressif__rmaker_common_2", "-lmqtt", "-lespressif__rmaker_cmd_resp", "-lespressif__rmaker_console", "-lespressif__rmaker_system_ctrl", "-lespressif__rmaker_time_sync", "-lespressif__rmaker_common_events", "-lespressif__rmaker_work_queue", "-lespressif__cbor", "-lespressif__esp_schedule", "-lespressif__esp_daylight", "-lespressif__network_provisioning", "-lprotocomm", "-lbt", "-lble_app", "-lbt", "-lble_app", "-lble_mesh", "-lconsole", "-lprotobuf-c", "-ljson", "-lespressif__qrcode", "-ljoltwallet__littlefs", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lc", "-lm", "-lstdc++", "-lpthread", "-lnewlib", "-lgcc", "-lcxx", "-lphy", "-lbtbb", "-lesp_phy", "-lphy", "-lbtbb", "-lesp_phy", "-lphy", "-lbtbb"
    ],
