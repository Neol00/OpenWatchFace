...
#define CONFIG_SOC_LP_CORE_HW_AUTO_CLRWAKEUPCAUSE 1
#define CONFIG_SOC_LP_CORE_LP_UART_WAKEUP_KEEP_TRIGGERED 1
...
#define CONFIG_BT_NIMBLE_BLUFI_ENABLE 1
...
#define CONFIG_ESP_MATTER_MAX_DYNAMIC_ENDPOINT_COUNT 4
