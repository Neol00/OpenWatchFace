...
#
# IF YOU ONLY WANT THE DEVICE TREE, you do not need root or TWRP at all —
# boot Wear OS normally, enable ADB, and run:
#
#     adb pull /sys/firmware/fdt  ticwatch-c2.dtb
#
# That single file settles the panel, the touch controller and the memory
# carve-outs, which is most of what the port is blocked on. This script is
# the FULL backup: take it before anything is flashed, because after that
# the stock images are gone for good.
#
